        ...
        <div style={{ width: "100%", padding: 8, height: "100%", maxWidth: "800px", minHeight: "100vh", margin: "0px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <p style={{ fontSize: "16px", lineHeight: "100%", marginTop: "8px", fontStyle: "italic" }}>a short reading on time.</p>
            </div>
          ...
          <div style={{ marginTop: "32px", maxWidth: "90%", marginBottom: "32px" }}>
               ...
               <p style={{ fontSize: "20px", fontWeight: "500", marginBottom: "16px" }}>Good practice involves</p>
               <ul style={{ fontSize: "18px", lineHeight: "1.8", paddingLeft: "24px" }}>
           ...
           <div style={{ marginTop: "32px", maxWidth: "90%", marginBottom: "32px" }}>
                ...
                <p style={{ fontSize: "18px", lineHeight: "1.6", marginBottom: "0px" }}>
           ...
           <div style={{ marginTop: "32px", maxWidth: "90%", marginBottom: "32px" }}>
               ...
               <p style={{ fontSize: "16px", lineHeight: "1.6", marginBottom: "8px", fontStyle: "italic" }}>
